...
CONTEST_CHANNEL_ID = 1404857696666128405  # bot-testing channel (used in roles.py and contest_builder.py)
CHALLENGE_CHANNEL_ID = 1404857696666128405  # bot-testing channel (used in roles.py and contest_builder.py)
ANNOUNCEMENT_CHANNEL_ID = 1404857696666128405  # Same as contest channel (contest_builder.py)
